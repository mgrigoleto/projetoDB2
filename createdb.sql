...
LEFT JOIN aminoNutri am ON (am.codAminoNutri = f.codAminoNutri)
LEFT JOIN glicoNutri g ON (g.codGlicoNutri = f.codGlicoNutri)
LEFT JOIN lipiNutri lip ON (lip.codLipiNutri = f.codLipiNutri)
LEFT JOIN eletroNutri e ON (e.codEletroNutri = f.codEletroNutri)
LEFT JOIN oligoNutri o ON (o.codOligoNutri = f.codOligoNutri)
LEFT JOIN vitaminaNutri v ON (v.codVitaminaNutri = f.codVitaminaNutri)
LEFT JOIN solucaoNutri ag ON (ag.codSolucaoNutri = f.codSolucaoNutri)
;
